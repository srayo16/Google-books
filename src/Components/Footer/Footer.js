...
const Footer = () => {
    return (
        <div className='bg-neutral text-neutral-content'>
            <footer class="footer p-10  bg-neutral text-neutral-content container mx-auto">
                <div className='mx-auto lg:mx-fit'>
            ...
            <footer class="footer px-10 py-4 border-t  bg-neutral text-neutral-content border-base-300 container mx-auto">
                <div class="items-center grid-flow-col">
                    ...
                    <p>Repsoft Consultancy Services Private Limited (copyright)  <br />Providing reliable tech since 1992</p>
                </div>
